...
(defparameter +sources+
  '(:3b-bmfont       "https://github.com/3b/3b-bmfont.git"
    ...
    :3d-math         "https://codeberg.org/shinmera/3d-math.git"
    :3d-spaces       "https://codeberg.org/shirakumo/3d-spaces.git"
    :40ants-doc      "https://github.com/40ants/doc.git"
    :abnf-match      "https://github.com/pyramidi0n/abnf-match.git"
    :access          "https://github.com/AccelerationNet/access.git"
    :acclimation     "https://github.com/robert-strandh/Acclimation.git"
    :action-list     "https://codeberg.org/shinmera/action-list.git"
    :adopt           "https://github.com/sjl/adopt.git"
    :agutil          "https://github.com/alex-gutev/agutil.git"
    ...
    :boost-json      "https://github.com/cl-boost/json.git"
    :binary-structures "https://codeberg.org/shinmera/binary-structures.git"
    :binascii        "https://github.com/froydnj/binascii.git"
    :binding-arrows  "https://github.com/phoe/binding-arrows.git"
    ...
    :cl-bcrypt       "https://github.com/dnaeon/cl-bcrypt.git"
    :cl-beanstalk    "https://github.com/antifuchs/cl-beanstalk.git"
    :cl-bmp          "https://codeberg.org/shinmera/cl-bmp.git"
    ...
    :cl-environments "https://github.com/alex-gutev/cl-environments.git"
    :cl-fad          "https://github.com/edicl/cl-fad.git"
    :cl-fbx          "https://codeberg.org/shirakumo/cl-fbx.git"
    :cl-fond         "https://codeberg.org/shirakumo/cl-fond.git"
    :cl-form-types   "https://github.com/alex-gutev/cl-form-types.git"
    :cl-freetype2    "https://github.com/rpav/cl-freetype2.git"
    :cl-ftp          "https://github.com/pinterface/cl-ftp.git"
    :cl-gamepad      "https://codeberg.org/shirakumo/cl-gamepad.git"
    :cl-glib         "https://github.com/bohonghuang/cl-glib.git"
    :cl-gltf         "https://codeberg.org/shirakumo/cl-gltf.git"
    ...
    :cl-gog-galaxy   "https://codeberg.org/shinmera/cl-gog-galaxy.git"
    ...
    :cl-mpg123       "https://codeberg.org/shirakumo/cl-mpg123.git"
    ...
    :cl-opus         "https://codeberg.org/shirakumo/cl-opus.git"
    ...
    :cl-qoa          "https://codeberg.org/shinmera/cl-qoa.git"
    ...
    :cl-turbojpeg    "https://codeberg.org/shirakumo/cl-turbojpeg.git"
    ...
    :cl-vorbis       "https://codeberg.org/shirakumo/cl-vorbis.git"
    ...
    :classowary      "https://codeberg.org/shinmera/classowary.git"
    :clavier         "https://github.com/mmontone/clavier.git"
    :clingon         "https://github.com/dnaeon/clingon.git"
    :clip            "https://codeberg.org/shinmera/clip.git"
    :clj-arrows      "https://github.com/dtenny/clj-arrows.git"
    :clj-coll        "https://github.com/dtenny/clj-coll.git"
    :clog            "https://github.com/rabbibotton/clog.git"
    ...
    :cmd             "https://github.com/ruricolist/cmd.git"
    :cocoas          "https://codeberg.org/shinmera/cocoas.git"
    :collectors      "https://github.com/AccelerationNet/collectors.git"
    :colored         "https://codeberg.org/shinmera/colored.git"
    ...
    :com-on          "https://codeberg.org/shinmera/com-on.git"
    ...
    :contextl        "https://codeberg.org/pcostanza/contextl.git"
    :convex-covering "https://codeberg.org/shirakumo/convex-covering.git"
    :croatoan        "https://codeberg.org/McParen/croatoan.git"
    :crypto-shortcuts "https://codeberg.org/shinmera/crypto-shortcuts.git"
    :cxml            "https://github.com/sharplispers/cxml.git"
    :cxml-stp        "https://github.com/sharplispers/cxml-stp.git"
    ...
    :data-table      "https://github.com/AccelerationNet/data-table.git"
    :db3             "https://github.com/dimitri/cl-db3.git"
    :dbi             "https://github.com/fukamachi/cl-dbi.git"
    :definitions     "https://codeberg.org/shinmera/definitions.git"
    :deflate         "https://github.com/pmai/Deflate.git"
    :defpackage-plus "https://github.com/rpav/defpackage-plus.git"
    :defstar         "https://github.com/lisp-maintainers/defstar.git"
    :deploy          "https://codeberg.org/shinmera/deploy.git"
    :depot           "https://codeberg.org/shinmera/depot.git"
    ...
    :feedback        "https://codeberg.org/shirakumo/feedback.git"
    :fiasco          "https://github.com/joaotavora/fiasco.git"
    :file-attributes "https://codeberg.org/shinmera/file-attributes.git"
    :file-finder     "https://github.com/lisp-maintainers/file-finder.git"
    :file-notify     "https://codeberg.org/shinmera/file-notify.git"
    ...
    :float-features  "https://codeberg.org/shinmera/float-features.git"
    :flow            "https://codeberg.org/shinmera/flow.git"
    ...
    :font-discovery  "https://codeberg.org/shinmera/font-discovery.git"
    :for             "https://codeberg.org/shinmera/for.git"
    :form-fiddle     "https://codeberg.org/shinmera/form-fiddle.git"
    :framebuffers    "https://codeberg.org/shirakumo/framebuffers.git"
    :frugal-uuid     "https://github.com/ak-coram/cl-frugal-uuid.git"
    :fset            "https://gitlab.common-lisp.net/fset/fset.git"
    :ftw             "https://github.com/fjames86/ftw"
    :function        "https://github.com/jrm-code-project/function.git"
    :function-cache  "https://github.com/AccelerationNet/function-cache.git"
    :garbage-pools   "https://github.com/archimag/garbage-pools.git"
    :generic-arithmetic "https://github.com/jrm-code-project/generic-arithmetic.git"
    :generic-cl      "https://github.com/alex-gutev/generic-cl.git"
    :gettext         "https://github.com/rotatef/gettext.git"
    :glfw            "https://codeberg.org/shirakumo/glfw.git"
    ...
    :glsl-toolkit    "https://codeberg.org/shirakumo/glsl-toolkit.git"
    ...
    :input-event-codes "https://git.sr.ht/~shunter/input-event-codes"
    ...
    :lambda-fiddle   "https://codeberg.org/shinmera/lambda-fiddle.git"
    :lambdalite      "https://github.com/Wukix/LambdaLite.git"
    :language-codes  "https://codeberg.org/shinmera/language-codes.git"
    :lass            "https://codeberg.org/shinmera/LASS.git"
    ...
    :lisp-critic     "https://github.com/g000001/lisp-critic.git"
    ...
    :lquery          "https://codeberg.org/shinmera/lquery.git"
    ...
    :lw-compat       "https://codeberg.org/pcostanza/lw-compat.git"
    ...
    :magnet          "https://codeberg.org/wohonajax/magnet.git"
    :manifolds       "https://codeberg.org/shirakumo/manifolds.git"
    ...
    :memory-regions  "https://codeberg.org/shinmera/memory-regions.git"
    :messagebox      "https://codeberg.org/shinmera/messagebox.git"
    ...
    :mmap            "https://codeberg.org/shinmera/mmap.git"
    :mockingbird     "https://github.com/pfdietz/mockingbird.git"
    :modf            "https://github.com/smithzvk/modf.git"
    :modularize      "https://codeberg.org/shinmera/modularize.git"
    :modularize-hooks "https://codeberg.org/shinmera/modularize-hooks.git"
    :modularize-interfaces "https://codeberg.org/shinmera/modularize-interfaces.git"
    :moira           "https://github.com/ruricolist/moira.git"
    ...
    :multilang-documentation "https://codeberg.org/shinmera/multilang-documentation.git"
    :mystic          "https://github.com/roswell/mystic.git"
    :myway           "https://github.com/fukamachi/myway.git"
    :named-let       "https://github.com/jrm-code-project/named-let.git"
    ...
    :north           "https://codeberg.org/shinmera/north.git"
    ...
    :nst             "https://github.com/jphmrst/cl-nst.git"
    ...
    :open-with       "https://codeberg.org/shinmera/open-with.git"
    ...
    :plump           "https://codeberg.org/shinmera/plump.git"
    :plurals         "https://github.com/fosskers/plurals.git"
    :pileup          "https://github.com/nikodemus/pileup.git"
    :piping          "https://codeberg.org/shinmera/piping.git"
    :png-read        "https://github.com/Ramarren/png-read.git"
    :pngload         "https://github.com/3b/pngload.git"
    :posix-shm       "https://git.sr.ht/~shunter/posix-shm"
    :postmodern      "https://github.com/marijnh/Postmodern.git"
    :precise-time    "https://codeberg.org/shinmera/precise-time.git"
    :print-licenses  "https://github.com/vindarel/print-licenses.git"
    :printv          "https://github.com/danlentz/printv.git"
    :priority-queue  "https://github.com/dsorokin/priority-queue.git"
    :proc-parse      "https://github.com/fukamachi/proc-parse.git"
    :progressons     "https://github.com/vindarel/progressons.git"
    :promise         "https://codeberg.org/shinmera/promise.git"
    ...
    :punycode        "https://codeberg.org/shinmera/punycode.git"
    ...
    :quicksearch     "https://github.com/tkych/quicksearch.git"
    :quri            "https://github.com/fukamachi/quri.git"
    :qt+libs         "https://github.com/commonqt/commonqt.git"
    :qt-libs         "https://codeberg.org/shinmera/qt-libs.git"
    :qtools          "https://codeberg.org/shinmera/qtools.git"
    :quickhull       "https://codeberg.org/shirakumo/quickhull.git"
    :quicklisp       "https://github.com/quicklisp/quicklisp-client.git"
    :radiance        "https://codeberg.org/shirakumo/radiance.git"
    :radiance-contrib "https://codeberg.org/shirakumo/radiance-contribs.git"
    :random-sampling "https://codeberg.org/shinmera/random-sampling.git"
    :random-state    "https://codeberg.org/shinmera/random-state.git"
    :raster          "https://codeberg.org/shirakumo/raster.git"
    :ratify          "https://codeberg.org/shinmera/ratify.git"
    :raylib          "https://github.com/fosskers/raylib.git"
    :read-line-crlf  "https://github.com/dtenny/read-line-crlf.git"
    :red-black-tree  "https://codeberg.org/wohonajax/red-black-tree.git"
    :repl-utilities  "https://github.com/m-n/repl-utilities.git"
    ...
    :routes          "https://github.com/archimag/cl-routes.git"
    ...
    :secret-values   "https://github.com/rotatef/secret-values.git"
    :secure-random   "https://github.com/avodonosov/secure-random.git"
    ...
    :simple-tasks    "https://codeberg.org/shinmera/simple-tasks.git"
    ...
    :system-locale   "https://codeberg.org/shinmera/system-locale.git"
    ...
    :trial           "https://codeberg.org/shirakumo/trial.git"
    :trial-assets    "https://codeberg.org/shirakumo/trial-assets.git"
    :trivia          "https://github.com/guicho271828/trivia.git"
    :trivial-arguments "https://codeberg.org/shinmera/trivial-arguments.git"
    ...
    :trivial-benchmark "https://codeberg.org/shinmera/trivial-benchmark.git"
    ...
    :trivial-deprecate "https://codeberg.org/shinmera/trivial-deprecate.git"
    ...
    :trivial-indent  "https://codeberg.org/shinmera/trivial-indent.git"
    :trivial-ldap    "https://github.com/rwiker/trivial-ldap.git"
    :trivial-main-thread "https://codeberg.org/shinmera/trivial-main-thread.git"
    :trivial-macroexpand-all "https://github.com/cbaggers/trivial-macroexpand-all.git"
    :trivial-mimes   "https://codeberg.org/shinmera/trivial-mimes.git"
    :trivial-monitored-thread "https://gitlab.com/ediethelm/trivial-monitored-thread.git"
    ...
    :trivial-us-ascii "https://github.com/pyramidi0n/trivial-us-ascii.git"
    :trivial-utf-8   "https://gitlab.common-lisp.net/trivial-utf-8/trivial-utf-8.git"
    :trivial-utilities "https://gitlab.com/ediethelm/trivial-utilities.git"
    ...
    :tuition         "https://github.com/atgreen/cl-tuition.git"
    :type-i          "https://github.com/guicho271828/type-i.git"
    :type-templates  "https://codeberg.org/shinmera/type-templates.git"
    :uax-14          "https://codeberg.org/shinmera/uax-14.git"
    :uax-15          "https://github.com/sabracrolleton/uax-15.git"
    :ubiquitous      "https://codeberg.org/shinmera/ubiquitous.git"
    ...
    :verbose         "https://codeberg.org/shinmera/verbose.git"
    :version-string  "https://github.com/atgreen/cl-version-string.git"
    :vgplot          "https://github.com/volkers/vgplot.git"
    :vom             "https://github.com/orthecreedence/vom.git"
    :wayflan         "https://git.sr.ht/~shunter/wayflan"
    :websocket-driver "https://github.com/fukamachi/websocket-driver.git"
    :which           "https://github.com/eudoxia0/which.git"
    ...
    :xpath           "https://github.com/sharplispers/xpath.git"
    ...
    :zippy           "https://codeberg.org/shinmera/zippy.git"
...
(let* ((quants (t:transduce (t:comp (t:segment 2)
       ...
       (total (t:transduce (t:map #'cdr) #'+ quants))
       (with-rel (t:transduce (t:map (lambda (pair) (list :dev (car pair)
                                                          :abs (cdr pair)
                                                          :rel (/ (cdr pair) (float total)))))
                              #'t:vector quants)))
  (sort with-rel #'> :key (lambda (list) (getf list :abs))))
...
;; FIXME: 2025-09-02 This needs to be less O(n).
(defun get-parent (sys)
  (or (getf +parents+ sys)
      ...
      (when (string-starts-with? (symbol-name sys) "SERAPEUM/") :serapeum)
